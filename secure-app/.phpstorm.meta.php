...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.admin_registration_pin' => 'string',
            'app.hashed_admin_registration_pin' => 'NULL',
            ...
            'filesystems.links./var/www/secure-app/public/storage' => 'string',
...
'app.aliases.Vite','app.admin_registration_pin','app.hashed_admin_registration_pin','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/secure-app/public/storage',
...
'web','api',);
        registerArgumentsSet('routes', 'dashboard','profile.edit','profile.update','profile.destroy',
'admin.users','admin.users.delete','admin.users.edit-permissions','admin.users.update-permissions','admin.users.show',
'admin.folders.index','admin.folders.create','admin.folders.store','admin.folders.edit','admin.folders.update',
'admin.folders.destroy','admin.folders.show','admin.folders.edit-folder','admin.folders.files','admin.folders.files.upload',
'admin.folders.files.destroy','admin.temporary-link.index','admin.temporary-link.destroy','client.folders.show','client.folders.files',
'client.files.destroy','client.folders.index','files.generate-temporary-link','temporary-link.access','admin.temporary-link.create',
'admin.temporary-link.store-upload','temporary-upload.form','admin.files','upload.standalone','files.download',
'files.view','files.destroy.standalone','register','login','password.request','password.email','password.reset','password.store',
...
'components.secondary-button','components.text-input','dashboard','files','folders',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ADMIN_REGISTRATION_PIN',);
